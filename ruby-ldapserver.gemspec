...
Gem::Specification.new do |s|
  ...
  s.version = "0.13.1.20121028125946"
  ...
  s.files = ["COPYING", "ChangeLog", "Manifest.txt", "README", "Rakefile", "examples/README", "examples/mkcert.rb", "examples/rbslapd1.rb", "examples/rbslapd2.rb", "examples/rbslapd3.rb", "examples/speedtest.rb", "lib/ldap/server.rb", "lib/ldap/server/connection.rb", "lib/ldap/server/filter.rb", "lib/ldap/server/match.rb", "lib/ldap/server/operation.rb", "lib/ldap/server/preforkserver.rb", "lib/ldap/server/result.rb", "lib/ldap/server/schema.rb", "lib/ldap/server/server.rb", "lib/ldap/server/syntax.rb", "lib/ldap/server/tcpserver.rb", "lib/ldap/server/util.rb", "lib/ldap/server/version.rb", "test/core.schema", "test/encoding_test.rb", "test/filter_test.rb", "test/match_test.rb", "test/schema_test.rb", "test/syntax_test.rb", "test/test_helper.rb", "test/util_test.rb", ".gemtest"]
